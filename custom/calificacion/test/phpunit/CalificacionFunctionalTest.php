...
/**
 * \file    test/phpunit/CalificacionFunctionalTest.php
...
/**
 * Class CalificacionFunctionalTest
 *
 ...
 */
class CalificacionFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 501591; // TODO: autodetect?
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modCalificacion')->click();
		} else {
			// Disable the module
			$this->byHref('modCalificacion')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/calificacion/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('calificacion/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/calificacion/admin/about.php');
		$this->authenticate();
		return $this->assertContains('calificacion/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('calificacionwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCalificacion_CalificacionTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCalificacion_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
